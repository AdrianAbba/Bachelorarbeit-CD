...
var iom = iom || (function () {
  var dummySite = "dummy",
      ...
      socioToken = "f96e6ab03c0b3e59a6475bacdb401f2d",
      frequency = 60000,
      hbiAdShort = 5000,
      hbiAdMedium = 10000,
      hbiAdLong = 30000,
  ...
  function buildResult(params) {
    ...
    result.cb = "0009";
    result.i2 = "00097ff890b76056759a6475b";
    result.ep = 1526538930;
    result.vr = "406";
  ...
  function getPlus() {
    if (typeof localStorage === 'object' && typeof localStorage.getItem === 'function') {
      ...
      var checkForSocio = 'https:' + '//' + ioplusurl + '/soziodata2.php?sc=' + socioToken + '&st=' + result.st;
      var XHR = createCORSRequest('GET', checkForSocio);
      if (XHR) {
        XHR.onload = function() {
          var blockedUntilDate = new Date();
          blockedUntilDate.setTime(blockedUntilDate.getTime() + lsottl);
          localStorage.setItem("ioamplusdata", XHR.responseText);
